...
public class DiamondRailBlock {
    ...
    public static final Block DIAMOND_RAIL = register(
    ...
    public static void registerModBlocks() {
        Diamondrails.LOGGER.info("Registering Diamond Rail block for " + Diamondrails.MOD_ID);
    }
}